...
vConinWS.onReceiveDataEvent(async (place, score) => {
    ...
    if (place > 0 && !rl.isQst) {
        ...
        con("Position in the top: " + place + "\tNumber of coins: " + formatScore(score, true), "yellow");
    }
});
...
vConinWS.onUserLoaded((place, score, items, top, firstTime, tick) => {
    con("User successfully uploaded.");
    con("Speed: " + formatScore(tick, true) + " Coins / tick.");
